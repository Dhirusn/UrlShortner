...
namespace UrlShortener.Data.Migrations
{
    ...
    public partial class InitialMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    ShortCode = table.Column<string>(type: "character varying(10)", maxLength: 10, nullable: false),
                    UrlMappingShortCode = table.Column<string>(type: "character varying(10)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UrlClicks_UrlMappings_UrlMappingShortCode",
                        column: x => x.UrlMappingShortCode,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UrlClicks_UrlMappingShortCode",
                table: "UrlClicks",
                column: "UrlMappingShortCode");
